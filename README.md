...
- sessions are used to persist authentication

1. What does bcrypt do to help us store passwords in a secure manner.

- bcrypt hashes passwords adds salt and also time derivation

1. What does bcrypt do to slow down attackers?

- bcrypt uses time time to do a derivation and rehashes based on the number provided
